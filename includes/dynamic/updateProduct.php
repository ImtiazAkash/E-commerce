...
$updtID = $_GET['updtID'];
$sqlUpdtShow = "SELECT * FROM tbl_product WHERE product_id='$updtID'";
...
<body>
    <div class="container-sm mt-5 usr_box">
        ...
        <div class="mb-3">
                ...
                <input disabled="disabled" type="text" class="form-control" value="<?php echo $recUpdtShow->product_id; ?>">
                <input type="hidden" name="product_id" value="<?php echo $updtID ?>">
            </div>
